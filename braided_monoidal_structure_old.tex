\subsection{Braided Monoidal Structure Old}
...
\begin{defin}
    An $\Br$-monoidal category \todo{change naming} is a category $\Cotimes$ with a functor
    \[
        \Cotimes \to \Br
    \]
    satisfying
...
So for the next part, let $\pi \colon \Cotimes \to \Br$ be a $\Br$-monoidal categoryand we denote

...
In this part,
we will work a lot with $\Ex$ which is constructed from $\E_2$ using Definition \ref{def:Ox}. This gives us a nice way to talk about configurations and paths between

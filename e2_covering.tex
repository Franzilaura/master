...
level-wise. We will see that $\widetilde{E_2}(n)$, the universal coverings of $\E_2(n)$ for all $n \in \N$,
can be equipped with an operadic structure as well as a braid action. Hence, we
obtain another example of a braided operad.
Note that later there will be an alternative construction of $\widetilde{E_2}$ via Example \ref{eg:br-fib-trivial}

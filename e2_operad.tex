...
\begin{defin}
    ...
    satisfying
        \begin{enumerate}[(M1)]
            \item The functor $\pi$ is a op-fibration.
...
The tensor unit is given by the unique morphism $\langle 0 \rangle \to \langle 1 \rangle$ in $\Ex$. 

\todo{tensor unit diagrams analogously to \ref{SymMonBijection}}
...
\begin{proof}
    ...
    \todo{what are the c1 etc define them}
...
\end{proof}
    ...
    Which we did not require at this point. But in \cite{adrian} you can find a more general statement on how to construct an 
    operadic structure on the universal covering of a topological operad. \todo{Statement + Adrians lemma Nummer}.

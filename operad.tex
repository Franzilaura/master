...
\begin{rem}
    ...
    \]
    This functor is a op-fibration. The proof in proposition 
    ...
    Further, the Segal condition (M2) holds as it is a result of the op-fibration condition (M1) and the fact that $\rho^i$ is 
    ...
    \]
    The proof for this is analoguously to proposition \ref{SymMonBijection} as all morphisms in $\Fin$ that induce a 
...
a symmetric monoidal structure via a functor satisfying the op-fibration condition (M1) and Segal condition (M2), there is also a functor satisfying 
...
\begin{rem}
    ...
    planar operad. In other word we consider the indexing sets $I$ in definition \ref{coloroperad} to be finite 

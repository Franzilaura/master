...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{prop}\label{m1m2}
        \begin{enumerate}[(M1)]
            \item The forgetful functor $P \colon \Cotimes \to \Fin$ is a Grothendieck op-fibration.
...
\begin{rem}
    ...
    \]
    This functor is a op-fibration. The proof in \ref{m1m2} applies. Note that for the proof the fact 

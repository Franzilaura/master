...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    If not stated otherwise, when we talk about fibrations and op-fibrations in this thesis, we will always mean Grothendieck fibrations and Grothendieck 
    op-fibrations, respectively. Also note, that in \cite{kerodon}, these termes are refered to as cartesian and cocartesian fibration. 

...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        an inert morphism in $\Brx$, i.e. for a restriction to the active subset of
        ...
        $\beta^{-1}(k)$-labeled configuration. This diagram in $\Br$:
        \begin{center}
            \begin{tikzpicture}
                % Define node positions
        ...
        \begin{center}
            ...
            \end{tikzcd}
        \end{center}
        Hence, the functor is well-defined on objects up to unique
        ...
        $\bar{f}'$ lift the diagram and therefore have to be the unique lift
        for $g' \circ g$ and $f$:
        \begin{center}
            \begin{tikzcd}
                {[X_1, \dots, X_n]} \arrow[r, "!f"] \arrow[d, "g"']     & {[Y_1,

...
\begin{const}\label{con:braidmon} Let $\B$ be a representable colored braided
    ...
    From this calculation we see that equation (4.1) also holds for $\gamma(h
    ...
    configuration which we denote by $\mathbf{1}$.
...
given in Construction \ref{con:brx_monoidal}.

...
We can define a new colored operad with the crossed simplicial braid group as its indexing sets. Again, we would like
to consider the forgetful functor

$$\pi \colon \Ox \to \Delta B$$

which is an op-fibration and satisfies the Segal condition.
...
Thus, similarily to the symmetric case the following diagram would have to commute in $\Delta B$:
...
As it turns out, a short graphical calculation shows that the hexagon identities hold for $\Delta B'$.
\todo{add hexagon identities}
...
\todo{explain braid action on cartesian product}

Thus, we have to conclude that the crossed simplicial braid group is not the right candidate for our 
op-fibration.
